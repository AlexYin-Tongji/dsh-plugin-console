/**
 * Client envelope and deterministic CSS-module plugin adapted from
 * w2112515/dsh-plugin-marketplace@1d610b6 (MIT).
...
const PACKAGE_ID = 'dsh-plugin-console'
const CSS_PREFIX = '\0plugin-console-css:'
...
const client: UserConfig = {
  ...
  plugins: [{
    name: 'plugin-console-css-modules',
